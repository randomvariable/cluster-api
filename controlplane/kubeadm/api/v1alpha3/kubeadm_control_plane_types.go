...
// Condition describes the state of a statefulset at a certain point.
type Condition struct {
	...
	// LastUpdateTime is a thing
	LastUpdateTime metav1.Time `json:"lastTransitionTime,omitempty"`
