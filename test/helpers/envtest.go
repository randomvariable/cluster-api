...
func NewTestEnvironment() *TestEnvironment {
	...
	// Disable the minimum StartupTimeout value for machinehealthcheck webhook, so it does not need to be at least 30s
	clusterv1.DisableMinimumNodeStartupTimeoutForTest()
...
// Mutate the name on the webhooks manifest files to avoid the name sharing clash
